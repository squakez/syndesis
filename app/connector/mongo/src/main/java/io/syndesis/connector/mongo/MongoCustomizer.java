        ...
        if (!options.containsKey("connectionBean")) {
            //if (options.containsKey("user") && options.containsKey("password") && options.containsKey("url")) {
                try {
                	...
                	/*
                    consumeOption(camelContext, options, "user", String.class, mongoClient::setUsername);
                    consumeOption(camelContext, options, "password", String.class, mongoClient::setPassword);
                    consumeOption(camelContext, options, "url", String.class, mongoClient::setUrl);
                	*/
                	//TODO Probably we will have to make some change to the upstream component
            ...
            /*} else {
                LOGGER.debug("Not enough information provided to set-up the Mongo client");
            }*/
        }
	}
